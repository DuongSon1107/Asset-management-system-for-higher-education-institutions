...
<div class="col-xs-12">
    <div class="x_panel">
        <div class="x_title">
            <h2><i class="fa fa-bars"></i> Quản lý danh mục tài sản</h2>
        ...
        <div class="x_content">
            <div class="" role="tabpanel" data-example-id="togglable-tabs">
                <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Tất cả danh mục</a> </li>
                    <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false"> Thêm danh mục</a> </li>
                </ul>
                <div id="myTabContent" class="tab-content">
                            ...
                            <table class="table table-hover table-striped table-bordered bulk_action" id="index_cat_table">
                               ...
                               <?php 
									...
									foreach ($arCat as $key => $value) {
										$id=$value["id_muctaisancha"];
										?>
										<tr data-id=<?=$id?>>
											<td style="width: 7%;text-align: center;"><?php echo $i?></td>
                                            <td style="width: 12%;text-align: center;"><?php echo $value["mamuctaisancha"]?></td>
											<td><?php echo $value["tenmuctaisancha"]?></td>
										
											<td style="width: 12%;text-align: center;">
												<a class="edit_dmcha" href="" title="Sửa" data-toggle="modal" data-target=".bs-example-modal-lg"><i class="fa fa-edit"></i></a>
                                                <a href="javascript:;" title="Xóa" id="del" onclick="xoa_danhmuc(<?php echo $value["id_muctaisancha"]?>)"><i class="fa fa-trash"></i></a>
											</td>
										</tr>
									<?php $i++;}?>
								</tbody>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                        <form id="index_dmcha" data-parsley-validate class="form-horizontal form-label-left" method="post" action="/admin/admin_cat/add_dmcha">
