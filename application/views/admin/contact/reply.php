<div class="compose-header"> Reply Message
    <button type="button" class="close reply-close"> <span>×</span> </button>
  </div>
  <div class="compose-body">
    ...
    <label for="">To</label>
    <input type="text" name=""  placeholder="" class="form">
    <div id="editor" class="editor-wrapper"><?php echo $arRep["content_mail"]?></div>
  </div>
