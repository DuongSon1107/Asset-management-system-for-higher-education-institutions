...
export default function DialogCreate({ open, handleClose, handleConfirm }: Props) {
  const { user } = useAuth()
  ...
  useEffect(() => {
    console.log(getValues().fromWarehouseId === undefined ? true : false)
  })
  ...
  return (
    <DialogCustomized open={open} handleClose={handleClose} handleConfirm={onSubmit} title='Thêm takeout' maxWidth='lg'>
        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={3}>
            <CustomTextField
              ...
              defaultValue={STATUS_TRANSFER.FIND}
