    ...
    buttons: [{
    ...
    },
     {
        ...
        customize: function (xlsx) {
                ...
                //insert
                var r1 = Addrow(1, [{ key: 'A', value: 'Trường Đại Học Bách Khoa Hà Nội' }, { key: 'B', value: ' Cộng hòa xã hội chủ nghĩa Việt Nam' }]);
                var r2 = Addrow(2, [{ key: 'A', value: 'Ha Noi University of Science and Technology' }, { key: 'B', value: ' Độc lập - Tụ do - Hạnh phúc' }]);
